# Runbook — sdkwork-mahjong deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-mahjong-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-mahjong/bundle`, loads the image, starts
