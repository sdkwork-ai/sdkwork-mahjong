# sdkwork-mahjong Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-mahjong` |
| `runtimeCode` | `mahjong` |
| Config root | `/etc/sdkwork/mahjong/` |
| Runtime TOML | `/etc/sdkwork/mahjong/config.toml` |
| Secrets | `/etc/sdkwork/mahjong/secrets/` |
| Override | `SDKWORK_MAHJONG_CONFIG_FILE` |
